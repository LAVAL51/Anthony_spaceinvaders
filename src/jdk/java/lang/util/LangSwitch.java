...
public class LangSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LangPackage.RUNTIME_EXCEPTION: {
				jdk.java.lang.RuntimeException runtimeException = (jdk.java.lang.RuntimeException)theEObject;
				T result = caseRuntimeException(runtimeException);
